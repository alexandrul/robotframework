...
if sys.platform.startswith('java'):
    ENTRY_POINTS = {'jybot': 'robot.run:entry_point', 'jyrebot': 'robot.rebot:entry_point'}
elif sys.platform == 'cli':
    ENTRY_POINTS = {'ipybot': 'robot.run:entry_point', 'ipyrebot': 'robot.rebot:entry_point'}
else:
    ENTRY_POINTS = {'pybot': 'robot.run:entry_point'}

ENTRY_POINTS.update({
    'robot': 'robot.run:entry_point',
    'rebot': 'robot.rebot:entry_point'
})
